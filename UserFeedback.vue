<template>
  <div class="main-content">
    <div style="font-size: 20px; font-weight: 400; margin-bottom: 20px">我的反馈（{{ data.total }}）</div>
      ...
      <el-table stripe tooltip-effect="dark myEff" :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="反馈图片">
          <template #default="scope">
            <el-image style="width: 100px; height: 100px; display: block; border-radius: 5px" :src="scope.row.img" :preview-src-list="[scope.row.img]" preview-teleported></el-image>
          </template>
        </el-table-column>
        <el-table-column prop="time" label="发布时间"></el-table-column>
        <el-table-column prop="answer" label="反馈回复"></el-table-column>
    ...
    <el-dialog title="反馈回复" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="70px" style="padding: 20px">
        <el-form-item prop="answer" label="回复">
          <el-input type="textarea" :rows="3" v-model="data.form.answer" placeholder="请输入回复内容"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
