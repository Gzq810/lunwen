<template>
  <div style="width: 40%; margin: 20px auto; min-height: 100vh">
    <el-form  class="card" ref="formRef" :rules="data.rules" :model="data.user" label-width="80px" style="padding: 20px">
      <div style="text-align: center; font-size: 24px; font-weight: bold; margin-bottom: 20px">修改密码</div>
