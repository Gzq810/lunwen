<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #C64130">欢 迎 登 录</div>
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item>
          <el-button size="large" type="primary" style="width: 100%; border-color: #C64130; background-color: #C64130" @click="login">登 录</el-button>
        </el-form-item>
        <div style="text-align: right">
          还没有账号？请 <a style="color: #C64130" href="/register">注册</a>
        </div>
      </el-form>
    </div>
