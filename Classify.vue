  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe tooltip-effect="dark myEff" :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column show-overflow-tooltip prop="introduce" label="描述"></el-table-column>
    ...
    <el-dialog title="分类信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="introduce" label="描述">
          <el-input type="textarea" :rows="3" v-model="data.form.introduce" placeholder="请输入描述"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
