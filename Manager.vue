      ...
      <div class="manager-header-right">
        <el-dropdown style="cursor: pointer;">
          <div style="padding-right: 20px; display: flex; align-items: center;">
            ...
            <span style="margin-left: 5px; color: #333">{{ data.user.name }}</span>
            <el-icon color="#333"><arrow-down /></el-icon>
          </div>
          <template #dropdown>
            <el-dropdown-menu>
      ...
      <div class="manager-main-left">
        ...
        >
          ...
          <el-sub-menu index="1">
            ...
            <el-menu-item index="/manager/enroll">活动报名</el-menu-item>
            <el-menu-item index="/manager/classify">非遗分类</el-menu-item>
            <el-menu-item index="/manager/heritage">非遗信息</el-menu-item>
            <el-menu-item index="/manager/activity">活动信息</el-menu-item>
            <el-menu-item index="/manager/evaluate">活动评价</el-menu-item>
            <el-menu-item index="/manager/promote">宣传视频信息</el-menu-item>
            <el-menu-item index="/manager/carousel">轮播图信息</el-menu-item>
            <el-menu-item index="/manager/news">资讯信息</el-menu-item>
            <el-menu-item index="/manager/collect">活动收藏</el-menu-item>
            <el-menu-item index="/manager/notice">系统公告</el-menu-item>
            <el-menu-item index="/manager/feedback">问题反馈</el-menu-item>
          </el-sub-menu>
          <el-sub-menu index="2">
            <template #title>
              <el-icon><Menu /></el-icon>
